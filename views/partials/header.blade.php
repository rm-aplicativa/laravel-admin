                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="{{ url(Admin::url('auth/setting')) }}" class="btn btn-default btn-flat">{{ trans('admin::lang.setting') }}</a>
                            </div>
                            <div class="pull-right">
                                <a href="{{ url(Admin::url('auth/logout')) }}" class="btn btn-default btn-flat">{{ trans('admin::lang.logout') }}</a>
                            </div>
                        </li>
                    </ul>
                </li>
